...
<thead>
  <tr>
    <th style="width: 25%; text-align: left; padding: 12px; border: 1px solid #ddd; background-color: #f6f8fa;">key名</th>
    <th style="width: 35%; text-align: left; padding: 12px; border: 1px solid #ddd; background-color: #f6f8fa;">役割</th>
    <th style="width: 40%; text-align: left; padding: 12px; border: 1px solid #ddd; background-color: #f6f8fa;">適用要素の例</th>
  </tr>
</thead>
<tbody>
  <tr>
